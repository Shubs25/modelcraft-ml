...
def train_and_export():
    ...
    # Generate sample test_data.csv for user upload testing
    test_df = X_test.copy()
    test_df['default.payment.next.month'] = y_test.values
    test_df.head(100).to_csv("test_data.csv", index=False)
    print("Generated sample 'test_data.csv'.")
    ...
    for filename, model in models.items():
        joblib.dump(model, os.path.join("trained_model", filename))

    print("Successfully retrained and updated model binaries in trained_model/")
